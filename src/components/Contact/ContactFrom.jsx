...
const ContactFrom = () => {
  ...
  return (
    <div className='  lg:w-[529px]  '>
        <form action=""  ref={form} onSubmit={sendEmail}
        className ="text-secondary font-popins space-x-7 space-y-7 md:space-x-4">
        <input onChange={(e)=>handelChange(e)} value={formData.name}
        className='border border-primary outline-none rounded-lg px-3.5 py-2 md:w-[200px] lg:w-auto w-auto'
        type="text" name="from_name" id="from_name" placeholder='Your Name' />
        <input onChange={(e)=>handelChange(e)} value={formData.email}
        className='border border-primary outline-none rounded-lg px-4 py-2 md:w-[200px] lg:w-auto w-auto'
        type="email" name="from_email" id="from_email" placeholder='Your  Email' />
        <input onChange={(e)=>handelChange(e)} value={formData.phone}
         className='border border-primary outline-none rounded-lg px-4 py-2 w-auto md:w-[200px] lg:w-auto [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-moz-outer-spin-button]:appearance-none [&::-moz-inner-spin-button]:appearance-none'
        ...
        className='border border-primary outline-none rounded-lg px-4 py-2 w-[235px] md:w-[420px] lg:w-[490px] h-36 resize-none'
