     ...
     <div className='font-popins text-secondary h-full'>
        ...
        <article className='flex gap-x-[25px]'>
          ...
          <div className='space-y-3.5 w-[190px] pr-2 md:w-auto md:pr-0'>
            ...
            <p className='font-normal text-sm text-info md:w-[370px]'>Learn Computer Technology </p>
          </div>
        </article>
        ...
        <article className='flex gap-x-[25px]'>
          ...
          <div className='space-y-3.5 w-[190px] pr-2 md:w-auto md:pr-0'>
            ...
            <p className='font-normal text-sm text-info  md:w-[370px]'>Foundation of my knowledge. </p>
          </div>
        </article>
        </div>
       </div>
