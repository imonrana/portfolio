    ...
    <section className='mt-10 md:mt-20 lg:mt-40'>
        <div className='p-5 lg:px-10 xl-px-0 xl:p-0 xl:w-container mx-auto'>
          <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5}>
            ...
            <div className='bg-[#432D92]  lg:px-20 pt-10 pb-26 lg:pt-24 lg:pb-24 px-10 rounded-4xl flex sm:flex-row flex-col gap-x-24 sm:gap-x-3 lg:gap-x-12 xl:gap-x-24 items-center'>
                ...
                <div className='relative w-fit'>
                    ...
                    className=' w-48 md:w-[250px]  lg:w-[300px] px-4 py-4 md:py-5 lg:mt-0 mt-4 sm-px-[10px] lg:px-[20px] sm:py-[26px] bg-white rounded-[15px] outline-none font-popins font-semibold text-base'
                    type="email" name="newsEmail" id="newsEmail"  placeholder='Your e-mail here'/>
                    <input className='bg-primary py-4 px-4 mt-2 md:py-6  lg:mt-0 lg:py-[18px] lg:px-[20px] font-popins font-bold text-sm lg:text-lg  rounded-lg sm:rounded-r-[15px] text-secondary absolute left-0 md:left-auto md:bottom-auto md:top-1/2 -bottom-18 md:-right-20 lg:-right-28 md:-translate-y-1/2 cursor-pointer'
