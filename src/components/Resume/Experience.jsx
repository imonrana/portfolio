...
const Experience = () => {
  return (
    ...
    <h3 className='font-semibold text-2xl md:text-[2.5rem]'>Experience</h3>
    ...
    <article className='flex gap-x-[25px]'>
      ...
      <div className='space-y-3.5 w-[190px] pr-2 md:w-auto md:pr-0'>
        <h4 className='font-semibold text-xl md:text-2xl '>IT Officer <span className='text-sm text-info'> (Mar 2023 - Apr 2024)</span></h4>
        <h5 className='font-semibold text-base '>Echo cotton Mill’s Ltd, Gazipur.</h5>
        <p className='font-normal text-sm text-info md:w-[370px] '>Network Support, ERP software , CCTV support, It equipment maintains, It support , HR. Management ect.</p>
      </div>
    </article>
