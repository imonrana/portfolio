  ...
  return (
    <section>
        <div className='w-container mx-auto'>
            <SectionTitle subTitle="Professional Training" title= "Professional IT training form reputed IT centers"/>
        <div className='font-popins text-secondary h-full mt-[60px]'>
            ...
            <article className='flex gap-x-[25px]'>
              ...
              <div className='space-y-3.5'>
                <h4 className='font-semibold text-2xl'>MERN STACK Development  <span className='text-sm text-info'> (May 2024- Present)</span></h4>
                <h5 className='font-semibold text-base '>Creative IT Institute, Dhanmondi-04 </h5>
                <p className='font-normal text-sm text-info w-[370px]'>Learning Web Development, & App Development.</p>
              </div>
            </article>
            ...
            <article className='flex gap-x-[25px]'>
              ...
              <div className='space-y-3.5'>
                ...
                <h5 className='font-semibold text-base '>Creative IT Institute, Dhanmondi-04</h5>
                <p className='font-normal text-sm text-info w-[370px]'>Learn Responsive Professional web design.  </p>
              </div>
            </article>
            ...
            <article className='flex gap-x-[25px]'>
              ...
              <div className='space-y-3.5'>
                ...
                <p className='font-normal text-sm text-info w-[370px]'>Learn Microsoft Office Application & Bijoy Keyboard Typing.  </p>
              </div>
            </article>
